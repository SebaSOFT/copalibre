...
| **0293**           | **Public Tournament** (`/[org]/tournaments/[t]`) | Columnas numéricas de tablas de posiciones sin monoespaciado numérico forzado.                | Tablas no declaran `.cl-tabular-nums`, causando desalineación de columnas en móvil.                | Ninguna detectada.                                                                        | Incorporar `.cl-tabular-nums` y verificar alternancia de bandas (_Alternating Band Rule_).   |
