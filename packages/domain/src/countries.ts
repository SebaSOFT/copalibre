 ...
 */
export const ISO_3166_ALPHA_2_CODES: readonly string[] = [
...
const ISO_3166_ALPHA_2_SET = new Set(ISO_3166_ALPHA_2_CODES);

export function isValidCountryCode(code: string): boolean {
  return ISO_3166_ALPHA_2_SET.has(code.toUpperCase());
}
