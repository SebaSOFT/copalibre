/**
 * The eight interface languages this platform commits to (0051, extended by
 * 0057 with Mandarin Chinese). Stable ISO 639-1 codes only — never a display
 ...
 * every other code here (0057 design.md).
 */
