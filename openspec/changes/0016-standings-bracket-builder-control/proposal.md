...
`0003-rules-engine-neuron-js-adapter` (phase 3) and `0006-tournament-engine-fixtures-mvp-formats` (phase 6)
...
- **A6 Bracket/Seeding Builder**: two-pane layout — left seed-assignment list with per-seed
  ...
  states — rendering the fixture structure `0006-tournament-engine-fixtures-mvp-formats` (phase 6)
...
- **Consumes**: phase 3 (`0003-rules-engine-neuron-js-adapter`) explanation-trace contract, phase 6
  (`0006-tournament-engine-fixtures-mvp-formats`) fixture/bracket structure, phase 5 (`api-auth-jwt-
  openapi-contract`) generated API client, phase 11 (`0011-design-tokens-broadcast-command-precision`)
