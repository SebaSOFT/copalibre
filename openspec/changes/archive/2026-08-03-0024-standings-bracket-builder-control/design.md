...
calculation and its explanation trace; phase 7 owns fixture/bracket generation including the
...
**Non-Goals:**
- No new tiebreak or bracket-generation logic — that belongs entirely to phases 3 and 7.
...
- [Risk] Double-elimination bracket rendering is complex; a rendering bug could show a structurally
  ...
  winners/losers bracket rendering, sourced from the same fixture datasets phase 7 uses.
