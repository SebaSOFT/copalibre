...
Konfiguration, startet die Prozesse, verwaltet Module und sichert/stellt Daten wieder her. Jeder
Aufruf akzeptiert `--help`/`-h` — sowohl ohne Befehl (`copalibre --help`) als auch nach jedem Befehl
