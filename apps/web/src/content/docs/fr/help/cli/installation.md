...
Docker et Docker Compose sur l'hôte. Il n'est pas nécessaire d'installer PostgreSQL ni ses outils
clients — ils s'exécutent dans les conteneurs que `copalibre` gère.
...
`docs/self-hosting.md` dans le dépôt.
