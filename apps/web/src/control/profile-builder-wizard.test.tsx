...
describe('the tournament profile builder wizard', () => {
  ...
  it('adds a stage and pre-creates it in the submitted document', () => {
    ...
    fireEvent.change(formatSelects[formatSelects.length - 1] as HTMLSelectElement, {
    ...
    const request = submitted[0] as { disciplineAlias: string; document: { stages: unknown[] } };
