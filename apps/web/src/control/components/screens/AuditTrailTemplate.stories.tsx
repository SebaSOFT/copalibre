...
const meta = {
  title: 'Admin/Screens/AuditTrailTemplate',
  component: AuditTrailTemplate,
  args: {
...
} satisfies Meta<typeof AuditTrailTemplate>;
export default meta;
...
export const Failed: Story = {
  render: function Render(args) {
    const intl = useIntl();
    return (
      <AuditTrailTemplate {...args} error={intl.formatMessage(messages.auditTrailLoadFailed)} />
    );
  },
};
