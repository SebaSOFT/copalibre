...
export const messages: Record<string, string> = {
  ...
  'control.seeding.unresolvedEntrant': 'Teilnehmer {id}',
  ...
  'control.matchConsole.syncState': 'Synchronisierungsstatus: {state}',
  ...
  'control.matchConsole.unnamedEntrant': 'Unbenannter Teilnehmer',
  'control.matchConsole.clockCommands': 'Uhrbefehle',
  'control.matchConsole.startClock': 'Starten',
  'control.matchConsole.pauseClock': 'Pausieren',
  ...
  'control.matchConsole.categoryPositive': 'Positiv',
  'control.matchConsole.categoryNegative': 'Negativ',
  'control.matchConsole.categoryNeutral': 'Neutral',
  'control.matchConsole.segmentStatePending': 'ausstehend',
  'control.matchConsole.segmentStateActive': 'aktiv',
  'control.matchConsole.segmentStateCompleted': 'abgeschlossen',
  ...
  'control.review.editMembersTitle': 'Teammitglieder bearbeiten',
  'control.review.editMembersDescription': 'Rollen der Mitglieder von {team} ändern.',
  'control.review.saveMembers': 'Mitglieder speichern',
  ...
  'control.roles.description.admin':
    'Verwaltet alles, was die Organisation tut: erstellt und veröffentlicht Turniere, verwaltet jeden Benutzer, administriert jeden Verein und betreibt Spiele.',
  'control.roles.description.clubAdmin':
    'Verwaltet die Identität eines einzelnen Vereins (Name, Alias, Abkürzung und Emblem) ohne organisationsweiten Zugriff.',
  'control.roles.description.tournamentAdmin':
    'Leitet ein Turnier von Anfang bis Ende, ohne organisationsweite Reichweite.',
  'control.roles.description.referee':
    'Betreibt ein laufendes Spiel: erfasst Ereignisse, steuert die Uhr, löst Timer auf und wählt den Kader aus.',
  'control.roles.description.broadcaster':
    'Kennzeichnet jemanden, der eine Übertragung rund um ein Turnier produziert, statt es zu verwalten; gewährt heute keine operative Berechtigung.',
  'control.roles.description.viewer':
    'Die Organisationsrolle mit den wenigsten Rechten: gehört zur Organisation, ohne operative Berechtigungen zu gewähren.',
  'control.roles.learnMore': 'Mehr erfahren',
  'control.roles.inviteDialog.close': 'Schließen',
  'control.registration.modalClose': 'Schließen',
  'control.shell.drawerClose': 'Menü schließen',
  ...
  'control.roles.selectClubPlaceholder': 'Verein auswählen…',
  'control.roles.selectTournamentPlaceholder': 'Turnier auswählen…',
  ...
  'control.wizard.step.ruleset': 'Disziplinregeln',
  'control.wizard.ruleset.empty':
    'Diese Disziplin deklariert hier keine zusätzlich konfigurierbaren Regeln.',
  'control.wizard.step.window': 'Zeitfenster',
  'control.wizard.step.summary': 'Zusammenfassung',
  'control.wizard.formatPreview.title': 'Strukturvorschau',
  'control.wizard.formatPreview.illustrative': 'Illustrative Vorschau (8 Teilnehmer)',
  'control.wizard.formatPreview.capacity':
    '{count, plural, one {# Teilnehmer} other {# Teilnehmer}}',
  ...
  'control.wizard.problem.allocationAttributeKey':
    'Gewichtete Setzung benötigt ein Attribut zur Einordnung der Teilnehmer',
  'control.stageEditor.title': 'Phasen',
  'control.stageEditor.addStage': 'Phase hinzufügen',
  'control.stageEditor.removeStage': 'Entfernen',
  ...
  'control.stageEditor.seriesNeutralGround': 'Neutraler Platz',
  'control.stageEditor.seriesAccountPerSeries': 'Tabelle pro Serie zählen, nicht pro Spiel',
  'control.stageEditor.allocationLabel': 'Setzung',
  'control.stageEditor.allocationNone': 'Später entscheiden',
  'control.stageEditor.allocationAutomatic': 'Automatisch — Reihenfolge der vorherigen Phase',
  'control.stageEditor.allocationManual': 'Manuell — ich setze die Teilnehmer selbst',
  'control.stageEditor.allocationWeighted': 'Gewichtet — nach einem Teilnehmerattribut ordnen',
  'control.stageEditor.allocationAttributeKey': 'Attribut',
  'control.stageEditor.allocationDirection': 'Richtung',
  'control.stageEditor.allocationDirectionHigherFirst': 'Höherer Wert wird zuerst gesetzt',
  'control.stageEditor.allocationDirectionLowerFirst': 'Niedrigerer Wert wird zuerst gesetzt',
  'control.stageEditor.profilePreviewHint':
    'Dieses Turnier verwendet die eigenen Phasen des Profils, hier schreibgeschützt angezeigt.',
  ...
  'control.settings.featuredLabel': 'Auf der öffentlichen Seite der Organisation hervorheben',
  ...
  'control.tournamentHub.title': 'Phasen',
  'control.tournamentHub.stagesHeading': 'Phasen',
  'control.tournamentHub.empty': 'Dieses Turnier hat noch keine Phasen.',
  'control.tournamentHub.seeded': 'Ausgelost',
  'control.tournamentHub.unseeded': 'Nicht ausgelost',
  'control.tournamentHub.openStage': 'Phase {number} öffnen: {name}',
  'control.tournamentHub.loading': 'Phasen werden geladen…',
  'control.tournamentHub.loadFailed': 'Die Phasen dieses Turniers konnten nicht geladen werden.',
  'control.stageHub.title': 'Phase {number}',
  'control.stageHub.toolsHeading': 'Phasenwerkzeuge',
  'control.stageHub.seedingLink': 'Auslosung',
  ...
  'control.landing.loading': 'Kontrollpanel wird geladen…',
  'control.landing.errorTitle': 'Fehler beim Laden der Organisationen',
  'control.landing.errorGeneric': 'Organisation konnte nicht geladen werden',
  'control.landing.backToLogin': 'Zurück zur Anmeldung',
  'control.notFound.title': 'Bildschirm nicht gefunden',
  'control.notFound.body': 'Es gibt keinen Kontrollbildschirm für {path}.',
  'control.callback.loading': 'Anmeldung wird abgeschlossen…',
  'control.callback.errorTitle': 'Anmeldung konnte nicht abgeschlossen werden',
  'control.callback.backHome': 'Zurück zur Startseite',
  ...
  'control.liveConsole.subtitle': 'Live-Betriebskonsole für Turniere und laufende Spiele.',
  'control.liveConsole.loading': 'Live-Betrieb wird geladen…',
  'control.liveConsole.noActiveTournaments': 'Keine aktiven Turniere in dieser Organisation.',
  'control.liveConsole.createTournament': 'Turnier erstellen',
  'control.preferences.tokensLoading': 'Wird geladen…',
  'preferences.title': 'Persönliche Einstellungen',
  'preferences.patTitle': 'Persönliche Zugriffstoken',
  'preferences.patDescription':
    'Erstellen Sie Tokens, um direkt auf die API zuzugreifen. Sie werden nur einmal angezeigt.',
  'preferences.createPat': 'Token erstellen',
  'preferences.patLabel': 'Token-Bezeichnung',
  'preferences.patExpiresIn': 'Läuft ab in (Tagen)',
  'preferences.patCreated': 'Token erstellt. Kopieren Sie es jetzt:',
  'preferences.revokePat': 'Widerrufen',
  'preferences.noTokens': 'Keine aktiven persönlichen Zugriffstoken.',
  'preferences.patExpiresAt': 'Läuft ab: {date}',
  'control.analytics.subtitle': 'Leistungs- und Betriebsvolumenkennzahlen der Organisation.',
  'control.analytics.loading': 'Analysen werden geladen…',
  'control.analytics.totalTournaments': 'Turniere insgesamt',
  'control.analytics.tournamentsBreakdown':
    '{live} live · {upcoming} bevorstehend · {finished} beendet',
  'control.analytics.finishedTournaments': 'Beendete Turniere',
  'control.analytics.finishedDetail': 'Archivierte und abgeschlossene Ergebnisse',
  'control.analytics.storageUsed': 'Genutzter Speicher',
  'control.analytics.mediaFilesCount': '{count} Mediendateien',
  'control.analytics.noData': 'Keine Daten',
  'control.analytics.tournamentOverview': 'Turnierübersicht',
  'control.analytics.noTournaments': 'Keine Turniere gefunden.',
  'control.analytics.column.tournament': 'Turnier',
  'control.analytics.column.status': 'Status',
  'control.analytics.column.progress': 'Spielfortschritt',
  'control.analytics.column.liveMatches': 'Laufende Spiele',
  'control.analytics.matchProgress': '{resolved} / {total} Spiele',
  'control.analytics.status.draft': 'Entwurf',
  'control.analytics.status.upcoming': 'Bevorstehend',
  'control.analytics.status.live': 'Live',
  'control.analytics.status.finished': 'Beendet',
  'control.analytics.status.archived': 'Archiviert',
  'control.analytics.status.unknown': 'Unbekannt',
  'control.roster.rolePlayer': 'Spieler',
  'control.roster.roleSubstitute': 'Ersatzspieler',
  'control.roster.roleCoach': 'Trainer',
  ...
  'control.tournamentSummary.stagesHeading': 'Phasen',
  'control.tournamentSummary.stageLine': '{name}: {format}',
  'control.tournamentSummary.publicRegistrationOpen': 'Die öffentliche Anmeldung ist geöffnet.',
  'control.tournamentSummary.publicRegistrationClosed':
    'Die öffentliche Anmeldung ist geschlossen; Teilnehmer werden vom Organisator hinzugefügt.',
  'control.tournamentSummary.checkInRequired': 'Check-in ist erforderlich.',
  'control.tournamentSummary.checkInNotRequired': 'Check-in ist nicht erforderlich.',
  'control.tournamentSummary.checkInClosesAt': 'Der Check-in endet um {closesAt}.',
  'control.tournamentSummary.region': 'Region: {region}',
  'control.tournamentSummary.capacity': 'Kapazität: {capacity} Teilnehmer',
