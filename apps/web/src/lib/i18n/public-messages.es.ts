...
export const messages: Record<string, string> = {
  ...
  'publicWeb.ruleset.valueYes': 'Sí',
  'publicWeb.ruleset.valueNo': 'No',
  'publicWeb.ruleset.format.singleElimination': 'Eliminación simple',
  'publicWeb.ruleset.format.doubleElimination': 'Eliminación doble',
  'publicWeb.ruleset.format.roundRobin': 'Todos contra todos',
  'publicWeb.ruleset.format.roundRobinSingleLeg': 'Todos contra todos (ida)',
  'publicWeb.ruleset.format.roundRobinHomeAway': 'Todos contra todos (ida y vuelta)',
  'publicWeb.ruleset.format.league': 'Liga',
  'publicWeb.ruleset.format.swiss': 'Suizo',
  'publicWeb.ruleset.format.gauntlet': 'Gauntlet',
  'publicWeb.ruleset.format.bracketGroups': 'Grupos con llave',
  'publicWeb.ruleset.format.customBracket': 'Llave personalizada',
  'publicWeb.ruleset.format.ffaBracket': 'Llave todos contra todos',
  'publicWeb.ruleset.format.ffaLeague': 'Liga todos contra todos',
  ...
  'publicWeb.standings.playerDialog.loadingPlaceholder': 'Cargando datos del jugador...',
  'publicWeb.standings.playerDialog.loadingFetch': 'Cargando...',
  'publicWeb.standings.playerDialog.columnTournament': 'Torneo',
  'publicWeb.standings.playerDialog.columnTeam': 'Equipo',
  'publicWeb.standings.playerDialog.columnRole': 'Rol',
  'publicWeb.standings.playerDialog.loadError': 'No se pudieron cargar los datos del jugador.',
  ...
  'publicWeb.playerProfile.backTo': '← Volver a {name}',
  'publicWeb.playerProfile.photoAlt': '{name}',
  'publicWeb.playerProfile.photoPlaceholderAlt': 'Sin foto cargada',
  'publicWeb.playerProfile.tournamentStatsHeading': 'Estadísticas del Torneo',
  'publicWeb.playerProfile.tournamentTotalHeading': 'Total del Torneo',
  'publicWeb.playerProfile.matchByMatchHeading': 'Partido a Partido',
  'publicWeb.playerProfile.noTournamentStats':
    'No hay estadísticas de torneo registradas para este jugador.',
  'publicWeb.playerProfile.matchColumnHeading': 'Partido',
  'publicWeb.playerProfile.matchLabel': 'Etapa {stage} · Partido {match}',
  ...
  'publicWeb.tournamentsPage.thirdPlace': 'Tercer puesto',
  ...
  'publicWeb.matchesView.scheduledAtAriaLabel': 'Horario: {time}',
  ...
  'publicWeb.matchTimeline.heading': 'Cronología del partido',
  'publicWeb.matchTimeline.empty': 'Todavía no hay eventos disponibles.',
  ...
  'publicWeb.matchRosters.columnPlayer': 'Jugador',
  'publicWeb.matchRosters.columnRoles': 'Roles',
  'publicWeb.matchRosters.columnOnField': 'En cancha',
  'publicWeb.matchRosters.onFieldYes': 'Sí',
